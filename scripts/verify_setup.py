...
# This script prints emoji status lines. On Windows the default console code
# page (cp1252) can't encode them; reconfigure stdout/stderr to UTF-8 so the
# checks run in a plain console.
